              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: YeKe.bg0.withValues(alpha: 0.16),
                    borderRadius: BorderRadius.circular(16),
                    border: Border.all(color: YeKe.road),
                  ),
                  child: const Icon(
                    Icons.place,
                    color: YeKe.detained,
                ...
                const Text(
                  'Check areas with recent police activity',
                  style: TextStyle(
                    color: YeKe.text,
                    fontSize: 30,
                ...
                const SizedBox(height: 16),
                const Text(
                  "Use the 'Ping' feature to quickly report\npolice presence.\n"
                  "'Historic View' to check hotspot areas & notable incidents",
                  style: TextStyle(
                    color: YeKe.sub,
                    letterSpacing: 1.2,
                    fontSize: 14,
                ...
                const Text(
                  'YeKe never stores your location, ever.',
                  style: TextStyle(
                    color: YeKe.text,
                    fontSize: 15,
                    letterSpacing: 1.1,
